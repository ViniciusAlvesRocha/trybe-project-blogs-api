...
*Nome* | *Avaliação*
--- | :---:
13 - Sua aplicação deve ter o endpoint GET `post/search?q=:searchTerm` | :heavy_multiplication_x:
12 - Sua aplicação deve ter o endpoint DELETE `/user/me` | :heavy_multiplication_x:
11 - Sua aplicação deve ter o endpoint DELETE `post/:id` | :heavy_multiplication_x:
10 - Sua aplicação deve ter o endpoint PUT `/post/:id` | :heavy_multiplication_x:
9 - Sua aplicação deve ter o endpoint GET `post/:id` | :heavy_multiplication_x:
8 - Sua aplicação deve ter o endpoint GET `/post` | :heavy_check_mark:
7 - Sua aplicação deve ter o endpoint POST `/post` | :heavy_check_mark:
6 - Sua aplicação deve ter o endpoint GET `/categories` | :heavy_check_mark:
5 - Sua aplicação deve ter o endpoint POST `/categories` | :heavy_check_mark:
4 - Sua aplicação deve ter o endpoint GET `/user/:id` | :heavy_check_mark:
3 - Sua aplicação deve ter o endpoint GET `/user` | :heavy_check_mark:
2 - Sua aplicação deve ter o endpoint POST `/login` | :heavy_check_mark:
1 - Sua aplicação deve ter o endpoint POST `/user` | :heavy_check_mark:
